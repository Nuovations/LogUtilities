 ...
 *      output (also known as, stdout) stream.
 */

#ifndef LOGUTILITIES_LOGWRITERSTDOUT_HPP
#define LOGUTILITIES_LOGWRITERSTDOUT_HPP
...
namespace Nuovations
{
    ...
    namespace Log
    {
        ...
        namespace Writer
        {
             ...
             *    stdio(3)) standard output (also known as, stdout)
             *    stream.
             *
             *  @ingroup writer
             *
...
#endif /* LOGUTILITIES_LOGWRITERSTDOUT_HPP */
